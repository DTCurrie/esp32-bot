...
fn main() -> anyhow::Result<()> {
    ...
    let robot = {
        ...
        // let l_chan = ledc::LedcDriver::new(
        ...
        // let l_motor = MotorEsp32::new(
        //     PinDriver::output(periph.pins.gpio33)?,
        //     PinDriver::output(periph.pins.gpio32)?,
        //     l_chan,
        // );

        // let left_motor = Arc::new(Mutex::new(l_motor));

        // let r_chan = ledc::LedcDriver::new(
        ...
        let brd = EspBoard::new(
            pins,
            vec![Rc::new(RefCell::new(r)), Rc::new(RefCell::new(r2))],
        );

        let board = Arc::new(Mutex::new(brd));

        // let bs = Esp32WheelBase::new(left_motor.clone(), right_motor.clone());
        // let base = Arc::new(Mutex::new(bs));
        ...
        //         name: "left_motor".to_string(),
        //     },
        //     ResourceType::Motor(left_motor),
        // );
        ...
        //         r#type: "component".to_string(),
        //         subtype: "motor".to_string(),
        //         name: "right_motor".to_string(),
        //     },
        //     ResourceType::Motor(right_motor),
        // );
